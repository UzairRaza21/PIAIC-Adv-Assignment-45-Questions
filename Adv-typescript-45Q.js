...
// Question- 25
let align_color = ["red", "green", "yellow"];
if (align_color.indexOf("green") + 1) {
...
if (align_color.indexOf("green") + 1) {
    ...
    console.log("Alien's color is not green, You earned 10 points!");
}
// Question- 27
let select_color = "yellow";
if (select_color == "green") {
    console.log("Color is green, you earned 5 points!");
}
else if (select_color == "yellow") {
    console.log("Color is yellow, you earned 10 points");
}
else if (select_color == "red") {
    console.log("Color is red, you earned 15 points");
}
else {
    console.log("You have selected wrong color");
}
// Question- 28
let age = 40;
if (age < 2) {
...
// Question - 29
const favorite_fruits = ["Apple", "Mango", "Orange", "Grapes", "Pine-Apple"];
let position = favorite_fruits.indexOf("Orange");
if (position = 1) {
    console.log("You really like Apples");
}
else {
    console.log("Your favorite fruit is not here");
}
